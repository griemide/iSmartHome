...
// Wifi
#define STA_SSID               "HP LaserJet P1505n"      // Wifi SSID
#define STA_PASS               "vQ1tASKOUu"  // Wifi password
...
// Syslog
#define SYS_LOG_HOST           "gries.spdns.de"
...
// Ota
#if (ARDUINO >= 168)
  #define OTA_URL              "http://gries.spdns.de:80/api/arduino/" PROJECT ".ino.bin"
#else
  #define OTA_URL              "http://gries.spdns.de:80/api/arduino/" PROJECT ".cpp.bin"
#endif
...
#define NTP_SERVER1            "ntp1.t-online.de"
